...
class T(testbase.ANTLRTest):
    ...
    def testLexerFromFile(self):
        ...
        lexerMod = self.compileInlineGrammar(grammar, returnModule=True)
        lexerMod.main(["lexer.py", inputPath], stdout=stdout)
    ...
    def testLexerFromStdIO(self):
        ...
        lexerMod = self.compileInlineGrammar(grammar, returnModule=True)
        lexerMod.main(["lexer.py"], stdin=StringIO(input), stdout=stdout)
    ...
    def testCombined(self):
        ...
        parserMod.main(
            ["combined.py", "--rule", "r"], stdin=StringIO(input), stdout=stdout
        )
    ...
    def testGrammarImport(self):
        ...
        parserMod.main(["import.py", "--rule", "s"], stdin=StringIO("b"), stdout=stdout)
