...
class T(testbase.ANTLRTest):
    def execParser(self, grammar, grammarEntry, input, listener, parser_args={}):
        if listener is None:
            port = 49100
        ...
        try:
            lexerCls, parserCls = self.compileInlineGrammar(grammar, options="-debug")
    ...
    def testBasicParser(self):
        ...
        self.execParser(grammar, "a", input="a", listener=listener)
        ...
        # many).
        lt_events = [event for event in listener.events if event.startswith("LT ")]
        ...
        found = [event for event in listener.events if not event.startswith("LT ")]
    ...
    def testSocketProxy(self):
        ...
        debugger = self.execParser(grammar, "a", input="a", listener=None)
    ...
    def testRecognitionException(self):
        ...
        debugger = self.execParser(grammar, "a", input="a b", listener=None)
    ...
    def testPositiveClosureBlock(self):
        ...
        debugger = self.execParser(grammar, "a", input="a 1 b c 3", listener=None)
    ...
    def testBlock(self):
        ...
        debugger = self.execParser(grammar, "a", input="a 1", listener=None)
    ...
    def testRuleBlock(self):
        ...
        debugger = self.execParser(grammar, "a", input="1", listener=None)
